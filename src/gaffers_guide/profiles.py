...
PROFILES: dict[str, QualityProfile] = {
    "fast": QualityProfile(
        name="fast",
        description="Prioritises speed/latency. Lower resolution, no SAHI. Best for preview runs.",
        sahi_enabled=False,
        imgsz=640,
    ...
    "high_res": QualityProfile(
        name="high_res",
        description="Higher quality output at the cost of lower FPS. Good for full analysis.",
        sahi_enabled=False,
        imgsz=1280,
    ...
    "sahi": QualityProfile(
        name="sahi",
        description="Maximum ball recall using SAHI slicing. Highest runtime cost. Use for QA/debugging.",
        sahi_enabled=True,
        imgsz=1280,
