...
_s(useWebSocketProgress, "LrWWGqn+DPyk2wtFS6k3A+SY2mU=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function Hopper({ onComplete }) {
    _s();
    const { currentStep, isProcessing, error, startTracking } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useWebSocketProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWebSocketProgress"])();
...
_s(Hopper, "6Dn1R/mr2zYCRWrMHFDJa/8JLx0=", false, function() {
    return [
...
function TacticalDashboard({ job }) {
    ...
    const refreshEngineFootnote = ()=>{
        ...
        setEngineFootnote(e === "local" ? `Ollama (${m})` : "demo (cloud engine)");
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TacticalDashboard.useEffect": ()=>{
    ...
    const handleSendPrompt = async (e)=>{
        ...
        setIsTyping(true);
        const engine = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("gaffer-engine-type") : "TURBOPACK unreachable";
        const ollamaModel = ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.getItem("gaffer-ollama-model")?.trim() || "llama3";
        // #region agent log
        fetch("http://127.0.0.1:7265/ingest/b94af6c0-0f3f-4385-ab39-095f9a480704", {
            method: "POST",
            headers: {
        ...
        if (engine === "local") {
            const messages = [
                {
                    role: "system",
                    content: "You are Gaffer's Guide, a football (soccer) tactics assistant. Be concise and practical. When unsure, say what you would need from video or tracking data."
                },
                ...chatHistory.map((m)=>({
            ...
            try {
                ...
                fetch("http://127.0.0.1:7265/ingest/b94af6c0-0f3f-4385-ab39-095f9a480704", {
                    ...
                    body: JSON.stringify({
                        sessionId: "bb63ae",
                        hypothesisId: "H4",
                        location: "TacticalDashboard.tsx:ollama-response",
                        message: "Ollama proxy result",
                        data: {
                            httpOk: res.ok,
                            status: res.status,
                            hasContent: Boolean(data.content && data.content.length > 0),
                            err: data.error ?? null
                        },
                        timestamp: Date.now()
                    })
                ...
                // #endregion
                if (!res.ok) {
                    const errText = data.detail ?? data.error ?? `Chat request failed (${res.status})`;
                    setChatHistory((prev)=>[
                            ...prev,
                            {
                                id: (Date.now() + 1).toString(),
                                role: "ai",
                                text: `**Local model error:** ${errText}. Ensure Ollama is running (\`ollama serve\`) and the model is pulled (\`ollama pull ${ollamaModel}\`).`
                            }
                        ]);
                } else {
                    setChatHistory((prev)=>[
                ...
                setChatHistory((prev)=>[
                        ...prev,
                        {
                            id: (Date.now() + 1).toString(),
                            role: "ai",
                            text: `**Local model unreachable:** ${String(err)}`
                        }
                    ]);
            }
            setIsTyping(false);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: TIMELINE_DATA.map((data, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(TacticalDashboard, "iMRQYVLF2ATuIvtwiSUFUm0BB6I=");
...
_s(WorkspacePage, "USZtyNhx5sWdiMPWlNjKhLTO1QE=");
_c = WorkspacePage;
var _c;
...
//# sourceMappingURL=_0yzlv2p._.js.map